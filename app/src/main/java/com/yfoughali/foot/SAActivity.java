...
public class SAActivity extends AppCompatActivity {
    ...
    private void affichageClassementButeurs() {
        String url = "https://api.football-data.org/v2/competitions/SA/scorers?limit=15"; // url de la requete, ?limit=15 changement du nombre de buteurs affichés
    ...
    private View.OnClickListener PLlistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent MainActivity = new Intent(SAActivity.this, MainActivity.class);
